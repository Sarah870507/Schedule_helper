...
if not firebase_admin._apps:
  cred = credentials.Certificate("schedule-helper-e7613-firebase-adminsdk-fbsvc-3f2468cc6d.json")
...
if "user" in st.session_state:
    ...
    page = st.sidebar.radio("Go to", ["Home", "Settings", "Work", "Calendar"], key="main_nav_radio")
    if page == "Home":
  ...
  password = st.text_input("Password", value="Aliceinborderland10", type="password")
